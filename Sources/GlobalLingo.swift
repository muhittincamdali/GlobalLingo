...
/// 
/// GlobalLingo provides developers with professional-grade tools and patterns
/// for building exceptional iOS applications.
public final class GlobalLingo {
    ...
    public func configure() {
        ...
        print("✅ GlobalLingo configured successfully")
    }
    
    /// Reset the framework to initial state
    public func reset() {
        isConfigured = false
        print("🔄 GlobalLingo reset to initial state")
    }
